...
class AnalysisCache {
   ...
   ZNR计算结果 get_ZNR_new(unsigned long long& seed, long double znereq, int cls, function<long double(long double)> 加权 = ioealgo::指数加权, int algo_itr = 100000, int zini_itr = 20, long double 剪枝系数 = 0.3) {
